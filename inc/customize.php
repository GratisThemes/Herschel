...
function herschel_curtomize_register( $wp_customize ){
	...
	$wp_customize->add_control( 'breadcrumbs', array(
		'label'			=> __('Display breadcrumbs', 'herschel'),
	...
	$wp_customize->add_control( 'thumbnail_index', array(
		'label'			=> __('Display thumbnails on index pages', 'herschel'),
		'section'		=> 'design_options',
		'type'			=> 'checkbox',
	) );
	...
	$wp_customize->add_control( 'thumbnail_content', array(
		'label'			=> __('Display thumbnails on content pages', 'herschel'),
		'section'		=> 'design_options',
		'type'			=> 'checkbox',
	) );
	...
	$wp_customize->add_section( 'social_icons' , array(
		'title'      => __('Social Media Icons', 'herschel'),
		'priority'   => 50,
	) );
	...
	$wp_customize->add_control( 'footer_copyright', array(
		'label'			=> __('Show Copyright Icon', 'herschel'),
		'section'		=> 'footer',
		'type'			=> 'checkbox',
	) );
	...
	$wp_customize->add_control( 'footer_year', array(
		'label'			=> __('Show Current Year', 'herschel'),
		'section'		=> 'footer',
		'type'			=> 'checkbox',
	) );
	...
	$wp_customize->add_control( 'footer_advert', array(
		'label'			=> __('Advertise Theme Author', 'herschel'),
		'section'		=> 'footer',
		'type'			=> 'checkbox',
	) );
	...
	$wp_customize->add_control( 'scrolltotop', array(
		'label'			=> __('Scroll to top icon', 'herschel'),
		'section'		=> 'footer',
		'type'			=> 'checkbox',
	) );
}
