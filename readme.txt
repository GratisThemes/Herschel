...
- Added support for customizer selective refresh widgets
- Added support for the Gutenberg editor
- Improved keyboard navigation
- Improved scroll-to-top button styling
- Improved post tags styles
- Improved various spacing
- Improved attachment navigation
- Improved pagination syling
- Improved TimyMCE editor styles
- Cleaned up post formats
- Fixed RTL styles
- Updated Font Awesome from 4.6.3 to 5.11.2
